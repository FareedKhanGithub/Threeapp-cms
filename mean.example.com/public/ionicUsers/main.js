...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, cookieService) {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            providers: [
                ...
                _users_service__WEBPACK_IMPORTED_MODULE_12__["UsersService"],
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.logIn = function (user) {
        return this.http.post(this.url + 'login', user, httpOptions); //this is the login method used int he login.page.ts folder
    };
...
var UsersService = /** @class */ (function () {
    ...
    UsersService.prototype.edit = function (user) {
...
module.exports = __webpack_require__(/*! /var/www/Yours/Grandandroidionicnotes/threeapp/ionicUsers/src/main.ts */"./src/main.ts");
